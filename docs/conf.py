...
Affiliation = u'University of Chicago'
project = u'areaDetector: EPICS Area Detector Support'
copyright = u'2017, Mark Rivers, ' + Affiliation
...
version = open(os.path.join('..', 'RELEASE')).read().strip()
